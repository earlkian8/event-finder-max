  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-purple-50 flex items-center justify-center py-20">
      <div className="bg-white rounded-2xl shadow-lg p-8 border border-gray-100 max-w-lg w-full text-center">
        ...
        <h1 className="mt-4 text-5xl font-extrabold text-gray-800">404</h1>
        <p className="mt-2 text-lg text-gray-600">Oops — the page you’re looking for doesn’t exist.</p>
        <p className="mt-2 text-sm text-gray-500">Maybe try searching events or return to the homepage.</p>
